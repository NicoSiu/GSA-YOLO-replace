...
# Only used for gui
def automatic_label_tag2text(input_image, box_threshold, iou_threshold, text_threshold):

    # cfg
    config_file = "GroundingDINO/groundingdino/config/GroundingDINO_SwinT_OGC.py"  # change the path of the model config file
    tag2text_checkpoint = "./Tag2Text/tag2text_swin_14m.pth" # change the path of the model
