...
def load_image(image_path):
    ...
    image_pil = image_path.convert("RGB")  # image_path = image
...
# only used by gui
def ground_sam_inpainting(input_image, input_text, inpaint_text, box_threshold, text_threshold):
    ...
    det_prompt = input_text
    inpaint_prompt = inpaint_text
    cache_dir = None
    inpaint_mode = "first"
    device = "cuda"
